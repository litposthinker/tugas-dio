...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $data = query("SELECT * FROM stockbarang WHERE id ='$id'");
    $data = $data[0];
}

if (isset($_POST['submit'])) {
    (edit($_POST) > 0) ? header('Location: admin.php') : header('Location: edit.php?error');
}
?>
        ...
        <form action="" method="post">
            ...
            <div class="form-box text-left">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="harga" value="<?= rupiah($data['harga']) ?>" placeholder="Rp 10.000" maxlength="50" id="hargaproduk" autocomplete="off">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="kategori" value="<?= $data['jenis'] ?>" placeholder="pilih kategori" maxlength="25" list="kategori" id="kategoriproduk" onchange="kodeprodukChange(this.value)">
