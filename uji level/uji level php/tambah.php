        ...
        <form action="" method="post">
            ...
            <div class="form-box text-left">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="SM-00" disabled id="kodeproduk1">
                    <input type="hidden" name="kode" placeholder="SM-00" id="kodeproduk">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input autocomplete="off" type="text" class="form-control" name="satuan" placeholder="pilih satuan" maxlength="50" list="satuan" id="satuanproduk">
                    <datalist id="satuan">
                        <option>Gelas</option>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="kategori" placeholder="pilih kategori" maxlength="25" list="kategori" id="kategoriproduk" onchange="kodeprodukChange(this.value)">
